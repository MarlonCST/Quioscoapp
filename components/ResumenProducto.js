    ...
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div className=" md:w-4/6">
        ...
        <p className="text-sm font-bold mt-2 text-gray-700">
          Subtotal: {formatearCantidad(producto.precio * producto.cantidad)}
        </p>
      </div>
      <div>
        <button
          type="button"
          className="bg-sky-700 px-5 py-2 flex gap-2 text-white rounded-md font-bold uppercase shadow-md w-full "
        ...
        <button
          type="button"
          className="bg-red-700 px-5 py-2 flex gap-2 text-white rounded-md font-bold uppercase shadow-md w-full mt-3 "
